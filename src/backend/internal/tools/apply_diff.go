...
func (t *ApplyDiff) Description() string {
	return "Applies one or more search/replace operations to an existing file. Each block finds the FIRST occurrence of the search string and replaces it. Make the search string unique enough to match only the intended location."
}
			...
			"diff": {
				...
				"items": {
					...
					"properties": {
						"search": {
							"type": "string",
							"description": "Exact string to search for in the file. Only the FIRST occurrence will be replaced — ensure the string is unique within the file to avoid unintended replacements."
						},
						"replace": {
							"type": "string",
